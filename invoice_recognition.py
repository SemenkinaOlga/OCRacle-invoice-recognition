...
class Parameters:
    def __init__(self, pdf_converter: dp.PdfConverter = dp.PdfConverter.pymupdf,
                 ocr_method: ocr.OcrMethod = ocr.OcrMethod.pytesseract,
                 ner_method: ner.NerMethod = ner.NerMethod.key_words_extractor):
        self.pdfConverter =  pdf_converter
        self.ocrMethod = ocr_method
        self.nerMethod = ner_method

def run_invoice_recognition(data_images, params: Parameters):
